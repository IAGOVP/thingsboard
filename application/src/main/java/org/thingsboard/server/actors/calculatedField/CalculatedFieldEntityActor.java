...
/**
 * Per-entity actor that evaluates calculated fields bound to a single {@link org.thingsboard.server.common.data.id.EntityId}.
 *
 * <p>Routes {@link org.thingsboard.server.common.msg.MsgType} values to
 * {@link CalculatedFieldEntityMessageProcessor} (telemetry, relations, alarms, init/delete, state restore).
 */
@Slf4j
