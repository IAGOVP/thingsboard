...
/**
 * Per-tenant actor that manages calculated-field definitions, caches, and entity actor lifecycle.
 *
 * <p>Delegates to {@link CalculatedFieldManagerMessageProcessor} for partition changes, cache init,
 * and {@link org.thingsboard.server.common.msg.cf.CalculatedFieldEntityLifecycleMsg} events.
 */
@Slf4j
