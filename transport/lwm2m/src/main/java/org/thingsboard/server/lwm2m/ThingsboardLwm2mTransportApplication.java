...
/**
 * Spring Boot entry for the LwM2M transport microservice (Leshan).
 *
 * <p>Defaults config to {@code tb-lwm2m-transport}; scans {@code org.thingsboard.server.transport.lwm2m}.
 */
...
public class ThingsboardLwm2mTransportApplication {
    ...
    /** @param args CLI; adds {@code --spring.config.name=tb-lwm2m-transport} when absent */
