...
/**
 * Spring Boot entry for the CoAP transport microservice (Californium + coapserver).
 *
 * <p>Defaults config to {@code tb-coap-transport}; scans {@code org.thingsboard.server.transport.coap}.
 *
 * @see org.thingsboard.server.transport.coap.CoapTransportResource
 */
...
public class ThingsboardCoapTransportApplication {
    ...
    /** @param args CLI; adds {@code --spring.config.name=tb-coap-transport} when absent */
