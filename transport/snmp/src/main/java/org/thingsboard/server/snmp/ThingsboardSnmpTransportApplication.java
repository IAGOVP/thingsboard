...
/**
 * Spring Boot entry for the SNMP transport microservice (polling).
 *
 * <p>Defaults config to {@code tb-snmp-transport}; scans {@code org.thingsboard.server.transport.snmp}.
 */
...
public class ThingsboardSnmpTransportApplication {
    ...
    /** @param args CLI; adds {@code --spring.config.name=tb-snmp-transport} when absent */
