...
/**
 * Spring Boot entry for the MQTT transport microservice (Netty).
 *
 * <p>Defaults config to {@code tb-mqtt-transport}; scans {@code org.thingsboard.server.transport.mqtt}.
 *
 * @see org.thingsboard.server.transport.mqtt.MqttTransportHandler
 */
...
public class ThingsboardMqttTransportApplication {
    ...
    /** @param args CLI; adds {@code --spring.config.name=tb-mqtt-transport} when absent */
