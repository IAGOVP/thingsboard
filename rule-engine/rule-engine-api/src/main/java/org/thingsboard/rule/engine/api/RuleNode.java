...
/**
 * Declares a rule node plugin: UI metadata, configuration class, and relation types.
 * Annotated classes must implement {@link TbNode}.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.TYPE)
public @interface RuleNode {

    /** FILTER, ENRICHMENT, ACTION, EXTERNAL, FLOW, etc. */
    ComponentType type();

    /** Unique component name in the rule engine palette. */
    String name();
