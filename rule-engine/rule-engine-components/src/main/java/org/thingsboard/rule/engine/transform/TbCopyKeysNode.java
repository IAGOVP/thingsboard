...
@Slf4j
/**
 * Rule engine transformation node 'copy key-value pairs': Copies key-value pairs from message to message metadata or vice-versa. Implements org.thingsboard.rule.engine.api.TbNode.
 */
@RuleNode(
