...
/**
 * Flow rule node — <b>output</b>.
 *
 * <p>transfers the message to the caller rule chain
 * <br>Produces output of the rule chain processing. 
 *
 * <p>Implements {@link org.thingsboard.rule.engine.api.TbNode}. Configuration: {@link EmptyNodeConfiguration}.
 * <br>Documentation: <a href="https://thingsboard.io/docs/user-guide/rule-engine-2-0/nodes/flow/output/">https://thingsboard.io/docs/user-guide/rule-engine-2-0/nodes/flow/output/</a>
 */
@RuleNode(
