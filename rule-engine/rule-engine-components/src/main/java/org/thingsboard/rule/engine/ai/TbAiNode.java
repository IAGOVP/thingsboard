...
/**
 * Rule engine external node 'AI request': Sends a request to an AI model using system and user prompts. Supports JSON mode. Implements org.thingsboard.rule.engine.api.TbNode.
 */
)
