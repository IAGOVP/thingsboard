...
/**
 * External rule node — <b>AI request</b>.
 *
 * <p>Sends a request to an AI model using system and user prompts. Supports JSON mode.
 *
 * <p>Implements {@link org.thingsboard.rule.engine.api.TbNode}. Configuration: {@link TbAiNodeConfiguration}.
 * <br>Documentation: <a href="https://thingsboard.io/docs/user-guide/rule-engine-2-0/nodes/external/ai-request/">https://thingsboard.io/docs/user-guide/rule-engine-2-0/nodes/external/ai-request/</a>
 */
