...
/**
 * Filter rule node — <b>device profile switch</b>.
 *
 * <p>Route incoming messages based on the name of the device profile
 * <br>Route incoming messages based on the name of the device profile. The device profile name is case-sensitive  
 *
 ...
 * <br>Documentation: <a href="https://thingsboard.io/docs/user-guide/rule-engine-2-0/nodes/filter/device-profile-switch/">https://thingsboard.io/docs/user-guide/rule-engine-2-0/nodes/filter/device-profile-switch/</a>
 */
@RuleNode(
