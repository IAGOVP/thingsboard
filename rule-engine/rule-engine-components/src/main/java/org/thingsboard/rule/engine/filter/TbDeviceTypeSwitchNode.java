...
/**
 * Rule engine filter node 'device profile switch': Route incoming messages based on the name of the device profile Implements org.thingsboard.rule.engine.api.TbNode.
 */
@RuleNode(
