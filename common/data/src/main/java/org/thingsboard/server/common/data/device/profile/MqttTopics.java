...
/**
 * Canonical MQTT topic strings for ThingsBoard device, gateway, provision, and OTA transports.
 *
 * <p>v1 device API uses prefix {@link #BASE_DEVICE_API_TOPIC}; v2 uses compact paths under {@link #BASE_DEVICE_API_TOPIC_V2}.
 * Gateway traffic uses {@link #BASE_GATEWAY_API_TOPIC}. Referenced by {@code MqttTransportHandler} and device docs
 * at {@code transport/MQTT_TOPICS.md}.
 */
