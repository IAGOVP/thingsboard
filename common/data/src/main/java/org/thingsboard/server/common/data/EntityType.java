...
/**
 * Discriminator for all ThingsBoard entities (DB table, {@link org.thingsboard.server.common.data.id.EntityId}, protobuf).
 *
 * <p>{@link #getProtoNumber()} aligns with {@code EntityTypeProto} in {@code queue.proto}.
 * {@link #getTableName()} is the SQL table name when stored in PostgreSQL.
 */
