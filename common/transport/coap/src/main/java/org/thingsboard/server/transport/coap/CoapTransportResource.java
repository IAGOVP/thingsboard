...
/**
 * Californium CoAP resource implementing the device API (parallel to HTTP {@code /api/v1}).
 *
 * <p>URI layout: {@code /api/v1/{accessToken}/{featureType}[/{requestId}]}. Supports GET (attributes,
 * observe RPC/attributes), POST (telemetry, attributes, RPC). DTLS sessions tracked in
 * {@link org.thingsboard.server.coapserver.CoapServerService#getDtlsSessionsMap()}.
 *
 * <p>See {@code transport/PROTOCOLS.md#coap}.
 */
@Slf4j
