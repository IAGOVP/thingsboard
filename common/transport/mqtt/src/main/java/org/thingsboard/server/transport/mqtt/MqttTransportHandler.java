...
/**
 * Netty {@link ChannelInboundHandlerAdapter} for the MQTT transport: CONNECT auth, SUBSCRIBE/PUBLISH routing.
 *
 * <p>Device topics from {@link org.thingsboard.server.common.data.device.profile.MqttTopics} (v1/v2),
 * gateway multiplexing, provisioning, OTA chunk requests, and Sparkplug B. Delegates payload conversion
 * to {@link org.thingsboard.server.transport.mqtt.adaptors.MqttTransportAdaptor} and core I/O to
 * {@link org.thingsboard.server.common.transport.TransportService}.
 *
 * <p>Topic catalog: {@code transport/MQTT_TOPICS.md}.
 */
@Slf4j
