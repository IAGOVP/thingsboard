...
/**
 * Persistence API for {@link AlarmComment} on {@link Alarm}s.
 *
 * <p>Implementation: {@code dao} module ({@code BaseAlarmCommentService} / JPA DAO).
 * REST: {@code AlarmCommentController} in {@code application} ({@code /api/alarm/.../comment}).
 */
public interface AlarmCommentService {

    /** Creates or updates by comment id. */
