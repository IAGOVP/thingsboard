...
/**
 * Angular HTTP service: oauth2 REST wrappers (`@core/http`).
 */
@Injectable({
  providedIn: 'root'
})
export class OAuth2Service {
  ...
  /** Calls ThingsBoard REST `/api/oauth2/config/template, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/oauth2/client, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/oauth2/client/infos${pageLink.toQuery()}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/oauth2/client/infos?clientIds=${clientIds.join(, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/oauth2/client/${id}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/oauth2/loginProcessingUrl`. */
