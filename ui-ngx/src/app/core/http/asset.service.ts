...
/**
 * Angular HTTP service: asset REST wrappers (`@core/http`).
 */
@Injectable({
  providedIn: 'root'
})
export class AssetService {
  ...
  /** Calls ThingsBoard REST `/api/tenant/assetInfos${pageLink.toQuery()}&type=${type}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/tenant/assetInfos${pageLink.toQuery()}&assetProfileId=${assetProfileId}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/customer/${customerId}/assetInfos${pageLink.toQuery()}&type=${type}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/customer/${customerId}/assetInfos${pageLink.toQuery()}&assetProfileId=${assetProfileId}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/asset/${assetId}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/assets?assetIds=${assetIds.join(, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/asset/info/${assetId}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/asset/types, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/customer/public/asset/${assetId}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/customer/${customerId}/asset/${assetId}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/assets, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/tenant/assets?assetName=${assetName}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/edge/${edgeId}/asset/${assetId}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/edge/${edgeId}/assets${pageLink.toQuery()}&type=${type}, ...`. */
  ...
  /** Calls ThingsBoard REST `/api/asset/bulk_import`. */
