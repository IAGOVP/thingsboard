...
/**
 * Angular component: tencent map provider settings (ThingsBoard web UI).
 *
 * <p>Template UI for the ThingsBoard web application. Selector: `tb-tencent-map-provider-settings`.
 */
@Component({
...
export class TencentMapProviderSettingsComponent extends PageComponent implements OnInit, ControlValueAccessor, Validator {
   ...
   * write value.
   *
   * @param value value (TencentMapProviderSettings)
   */
