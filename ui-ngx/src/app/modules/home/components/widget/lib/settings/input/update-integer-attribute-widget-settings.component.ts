...
/**
 * Angular component: update integer attribute widget settings (ThingsBoard web UI).
 *
 * <p>Template UI for the ThingsBoard web application. Selector: `tb-update-integer-attribute-widget-settings`.
 */
@Component({
