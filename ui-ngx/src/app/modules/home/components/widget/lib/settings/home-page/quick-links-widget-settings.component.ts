...
/**
 * Angular component: quick links widget settings (ThingsBoard web UI).
 *
 * <p>Template UI for the ThingsBoard web application. Selector: `tb-quick-links-widget-settings`.
 */
@Component({
