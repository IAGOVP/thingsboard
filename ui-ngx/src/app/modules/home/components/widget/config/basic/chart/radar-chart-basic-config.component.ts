...
/**
 * Angular component: radar chart basic config (ThingsBoard web UI).
 *
 * <p>Template UI for the ThingsBoard web application. Selector: `tb-radar-chart-basic-config`.
 */
@Component({
...
export class RadarChartBasicConfigComponent extends LatestChartBasicConfigComponent<RadarChartWidgetSettings> {
   ...
   * @param settings settings (RadarChartWidgetSettings)
   */
