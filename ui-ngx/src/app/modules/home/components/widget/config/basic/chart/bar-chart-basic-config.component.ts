...
/**
 * Angular component: bar chart basic config (ThingsBoard web UI).
 *
 * <p>Template UI for the ThingsBoard web application. Selector: `tb-bar-chart-basic-config`.
 */
@Component({
...
export class BarChartBasicConfigComponent extends LatestChartBasicConfigComponent<BarChartWidgetSettings> {
   ...
   * @param settings settings (BarChartWidgetSettings)
   */
