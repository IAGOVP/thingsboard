...
/**
 * Angular component: filter user info dialog (ThingsBoard web UI).
 *
 * <p>Template UI for the ThingsBoard web application. Selector: `tb-filter-user-info-dialog`.
 */
@Component({
...
export class FilterUserInfoDialogComponent extends
  ...
  /**
   * Event handler for autogenerated label change.
   *
   */
