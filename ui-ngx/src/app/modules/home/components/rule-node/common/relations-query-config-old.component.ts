...
/**
 * Angular component: relations query config old (ThingsBoard web UI).
 *
 * <p>Template UI for the ThingsBoard web application. Selector: `tb-relations-query-config-old`.
 */
@Component({
