...
/**
 * Angular component: widget type tabs (home/widget pages).
 *
 * <p>Template UI for the ThingsBoard web application. Selector: `tb-widget-type-tabs`.
 */
@Component({
