 ...
 *
 * <p>Each public method maps to one or more HTTP endpoints on tb-node (see {@code baseURL + "/api/..."}). JWT is sent in the {@value org.thingsboard.rest.client.RestClient#TOKEN_HEADER_PARAM} header; the request interceptor refreshes tokens automatically.
 *
 * <p>Used by tests, monitoring, integrations, and tools. Server-side controllers live in the {@code application} module; full API catalog: {@code docs/REST_API.md}.
 */
 ...
 */
    ...
    /**
     * Auth type (ThingsBoard REST client).
     */
 ...
 */
    ...
    /**
     * Shuts down the internal executor service used for async REST calls.
     */
