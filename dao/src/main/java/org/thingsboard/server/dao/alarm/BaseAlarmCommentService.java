...
public class BaseAlarmCommentService extends AbstractEntityService implements AlarmCommentService {
    ...
    /** Sets default {@link AlarmCommentType#OTHER} when type is missing, then saves. */
    ...
    /**
     * Merges new comment JSON into {@code oldAlarmComment} and sets {@code edited} / {@code editedOn} flags.
     *
     * @return saved entity or {@code null} if old comment not found
     */
