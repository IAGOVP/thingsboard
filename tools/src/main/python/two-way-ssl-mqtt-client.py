...
"""
MQTT device client with mutual TLS (two-way SSL).

Uses mqttserver.pub.pem and mqttclient.nopass.pem; connects on port 8883.
Same attribute/RPC subscriptions as simple-mqtt-client.py.
"""
