...
"""
CI helper: ensure ThingsBoard YAML config properties have comments (min length 5).

Walks nested keys in thingsboard.yml and transport/msa YAML files; exits 1 if any
property lacks a nearby description. Run from repository root.
"""
