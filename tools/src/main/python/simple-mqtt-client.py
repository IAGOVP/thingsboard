...
"""
Sample ThingsBoard MQTT device client (plain TCP).

Subscribes to attributes and RPC topics, replies to server-side RPC, and requests
client attributes. Set device access token via username_pw_set before connect.

Topics: v1/devices/me/attributes, v1/devices/me/rpc/request/+, v1/devices/me/telemetry
