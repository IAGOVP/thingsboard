...
"""
MQTT device client with server-only TLS (one-way SSL).

Uses mqttserver.pub.pem as CA; connects on port 8883. Same attribute/RPC
subscriptions as simple-mqtt-client.py.
"""
